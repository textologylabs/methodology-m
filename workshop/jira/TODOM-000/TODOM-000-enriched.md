...
## Component PAT Mapping

| Component | Sub-Task | PATs Owned |
|-----------|----------|------------|
| todo-m-root | TODOM-000a | 1, 5, 6 |
| todo-m-mfe | TODOM-000b | 2, 3 |
| todo-m-api-read | TODOM-000c | 4 (GET /hello) |
| todo-m-api-write | TODOM-000d | 4 (POST /placeholder) |

## Sub-Tasks

- TODOM-000a — todo-m-root
- TODOM-000b — todo-m-mfe
- TODOM-000c — todo-m-api-read
- TODOM-000d — todo-m-api-write
